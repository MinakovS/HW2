...
I. ПЕРЕЧЕНЬ УСЛУГ ПО СОПРОВОЖДЕНИЮ:
...
- Консультации пользователей по работе с ПО, помощь в решении проблем в части прочих бизнес-процессов	
...
- Выдача и изменение пользовательских прав, ролей (по заявкам ключевых пользователей или службы безопасности)	
...
Поддержка оборудования и инфраструктуры системы (сервера, каналы связи, системное ПО, включая подсистему печати, сервер базы данных), лицензионные ключи на ПО, администрирование базы данных, в т.ч. обеспечение сохранности данных (резервное копирование).
